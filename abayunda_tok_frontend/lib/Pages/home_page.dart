...
class _HomePageState extends State<HomePage> {
  ...
  final List<String> _videoUrls = [
    ...
    //'http://10.0.2.2:9000/videos/becd7ecb-2e83-4afc-81f3-3a3f1284c3f3/master.m3u8',
    'http://10.0.2.2:9000/videos/1507c407-43d0-445e-92f9-66e3b64d850a/master.m3u8'
  ];
  ...
  Future<void> _initializePlayers() async {
    try {
      ...
      await firstVideo.initialize().timeout(const Duration(seconds: 20));
...
//   Future<void> _initializePlayers() async {
//     try {
//       // Создаем контроллеры для всех видео
//       _betterPlayerControllers = _videoUrls.map((url) {
...
//               showControls: false,
//             ),
//             // errorConfiguration: BetterPlayerErrorConfiguration(
//             //   errorBuilder: (context, errorMessage) {
//             //     return Center(child: Text('Ошибка видео: $errorMessage'));
//             //   },
//             // ),
//           ),
...
//       // Инициализируем первый плеер для быстрой проверки
//       // await _betterPlayerControllers.first.setupDataSource(
//       //   _betterPlayerControllers.first.dataSource!,
//       // );
